public class Liveries implements View {
  ...
  private Livery[][] liveryList = {
    {
      new Livery("red_purple_car.png", 1000),
      new Livery("green_car.png", 1000),
      new Livery("cyan_yellow_car.png", 5000),
      new Livery("white_blue_car.png", 5000),
      new Livery("purple_car.png", 5000)
    },
    {
      new Livery("salmon_car.png", 5000),
      new Livery("yellow_blue_car.png", 10000),
      new Livery("blue_car.png", 10000),
      new Livery("orange_car.png", 15000),
      new Livery("pink_blue_car.png", 25000),
    }
  };
